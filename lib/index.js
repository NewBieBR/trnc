...
commander_1.default
    ...
    var ok, config, template, packageCmd, _i, _a, packageName, cmd;
...
commander_1.default
    ...
    var config, template, template, newPackages, template;
    var _a, _b, _c;
        ...
        switch (_d.label) {
            ...
            case 1:
                ...
                if (cmdObj.add) {
                    ...
                    setConfig({
                        templates: __assign(__assign({}, config.templates), (_b = {}, _b[template.name] = __assign(__assign({}, template), { postInstall: cmdObj.args[1] }), _b)),
                    });
                }
                    ...
                    newPackages.shift();
                    setConfig({
                        templates: __assign(__assign({}, config.templates), (_c = {}, _c[template.name] = __assign(__assign({}, template), { packages: lodash_1.default.uniq(template.packages.concat(newPackages)) }), _c)),
                    });
                }
                else if (cmdObj.info) {
