...
commander_1.default
    ...
    var config, template, template, template, newPackages, template;
    var _a, _b, _c, _d;
        ...
        switch (_e.label) {
            ...
            case 1:
                ...
                if (cmdObj.add) {
                    ...
                    setConfig({
                        templates: __assign(__assign({}, config.templates), (_b = {}, _b[template.name] = __assign(__assign({}, template), { projectPath: cmdObj.args[1] }), _b)),
                    });
                }
